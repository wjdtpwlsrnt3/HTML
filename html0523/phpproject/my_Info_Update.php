...
<main class="form-signin w-100 m-auto">
  <form action="my_Info_Update_ok.php" method="post">
    ...
    <div class="form-floating">
      <input name="email" type="email" value="<?php echo $_SESSION['email']?>" class="form-control" id="floatingInput" placeholder="name@example.com" readonly> 
      <label for="floatingInput">Email address</label>
    </div>

    <div class="form-floating">
      <input name="prepassword" type="password" value="" class="form-control" id="floatingPassword" placeholder="Password">
      <label for="floatingPassword">기존 비밀번호</label>
    </div>
    
    <div class="form-floating">
      <input name="afterpassword" type="password" value="" class="form-control" id="floatingPassword" placeholder="Password">
